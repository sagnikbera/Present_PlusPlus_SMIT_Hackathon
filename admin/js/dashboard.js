(function($) {
  ...
  $(function() {
    ...
    if ($("#marketingOverviewweek").length) {
      var marketingOverviewChart = document.getElementById("marketingOverviewweek").getContext('2d');
    ...
    if ($("#marketingOverviewmonth").length) {
      var marketingOverviewChart = document.getElementById("marketingOverviewmonth").getContext('2d');
      var marketingOverviewData = {
          // labels: ["MON","TUE", "WED", "THU", "FRI", "SAT"],
          ...
          datasets: [{
              label: 'Last Year',
              // data: [10, 10, 9, 5, 11, 7],
              data: [11, 22, 20, 19, 22, 11, 21, 11, 20, 22, 21, 15],
            ...
            label: 'This Year',
            // data: [20, 14, 21, 25, 19, 23],
            data: [21, 29, 21, 25, 29, 23, 29, 21, 28, 26, 28, 30],
    ...
    if ($("#doughnutChart").length){
     ...
     if ($("#doughnutChartstudents").length){
      var doughnutChartCanvas = $("#doughnutChartstudents").get(0).getContext("2d");
      var doughnutPieData = {
        datasets: [{
          data: [50, 40, 40, 25,20],
          backgroundColor: [
