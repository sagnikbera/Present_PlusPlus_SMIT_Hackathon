                                ...
                                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link border-0 active" id="more-tab"
                                                    ...
                                                    <div class="card card-rounded">
                                                        <div class="card-body">
                                                            <div
                                                                ...
                                                                <div>
                                                                    <h4 class="card-title card-title-dash">Your Lectures</h4>
                                    ...
                                    <button class="btn btn-primary btn-lg text-white mb-0 me-0" type="button"><i class="mdi mdi-account-plus"></i>View All Students</button>
                                                            ...
                                                            <div class="table-responsive  mt-1">
                                                                <table class="table select-table">
                                                                                ...
                                                                                if($row["start"]==0){
                                                                                    ...
                                                                                    <td>
                                                                                        <div>
                                                                                            ...
                                                                                            <p class="text-success">'.$row["duration"].'</p>
                                                                                            <!-- <p>85/162</p> -->
                                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <div class="badge badge-opacity-success" onclick="startlecdata('.$row["lecid"].')">Start Now</div>
                                                                    </td>
                                                                    </tr>     
                                                                                ';
                                                                                }
                                                                    ...
                                                                    <td>
                                                                        <div class="badge badge-opacity-warning" onclick="startlec()">Live Now</div>
                                                                    </td>
                                                                    </tr>     
                                                                                ';
                                                                                }
                                                                ...
                                                                <td>
                                                                    <div class="badge badge-opacity-danger" ">Completed</div>
                                                                </td>
                                                                </tr>     
                                                                            ';
                                                                            }
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <div
                                                                            ...
                                                                            <h4 class="card-title card-title-dash">Class
                                                                                Regularities</h4>
                                                                        </div>
...
<script>
    function startlec(){
        // alert("hi");
        window.location.href="./startlecture.php";
    }
    function startlecdata(l){
        alert("lecture started");
        localStorage.setItem("lecid",l);
        window.location.href="./startlecture.php";


        // alert("hi");
        // window.location.href="./endlecture.php";
    }
</script>