        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-message-text-outline text-primary me-2"></i> Department</a>
              ...
              <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link " id="home-tab"  href="./index.php"  aria-selected="false">Overview</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link  ps-0" id="profile-tab" href="./studentslist.php"  aria-selected="true">Students list</a>
                    </li>
                     <li class="nav-item">
                      <!-- <a class="nav-link border-0" id="more-tab" data-bs-toggle="tab" href="#more" role="tab" aria-selected="false">Lectures</a> -->
                      <a class="nav-link border-0 active" id="more-tab"  href="./lectures.php" " aria-selected="false">Lectures</a>
                  ...
                  <div>
                    <div class="btn-wrapper">
                      ...
                      <!-- <a href="#" class="btn btn-primary text-white me-0"><i class="icon-download"></i> Export Report</a> -->
                    </div>
                  </div>
                </div>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">All Student Lists </h4>
                                   <p class="card-subtitle card-subtitle-dash"></p>
                                  </div>
                                  <div>
                                    <button class="btn btn-primary btn-lg text-white mb-0 me-0" type="button"><i class="mdi mdi-account-plus"></i>Notify Students</button>
                                  </div>
                                </div>
                                <div class="table-responsive  mt-1">
                                  <table class="table select-table">
                                    ...
                                    <tbody>
                                                                            ...
                                                                            // $p=$grpname;
                                                                            $sql = "SELECT * FROM users WHERE userid>5 ";
                                                                            ...
                                                                            if ($result->num_rows > 0) {
                                                                                ...
                                                                                while($row = $result->fetch_assoc()) {
                                                                                    ...
                                                                                    <td><div class="badge badge-opacity-success" onclick=giveatt(1,'.$row["userid"].')>1st attendance</div></td>

                                                                                    <td><div class="badge badge-opacity-warning">2nd attendance</div></td>
                                                                                    <td><div class="badge badge-opacity-info" onclick=giveatt(3,'.$row["userid"].')>3rd attendance</div></td>
                                                                                  </tr>
                                      ...
                                      <div class="row">
                                        <div class="col-lg-12">
                                          <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="card-title card-title-dash">Department Students</h4>
                                          </div>
                                          <canvas class="my-auto" id="doughnutChartstudents" height="200"></canvas>
...
<script>
    function giveatt(n,userid){
        alert("done");
   var lid=localStorage.getItem("lecid");

        $.ajax({
              type: "POST",
              url: "./phpfiles/giveatt.php",
            //   beforeSend: function() {
    // },
              data: {no:n,userid:userid,lid:lid},
